...
import { ProcessedMessageListRelationFilter } from "../../processedMessage/base/ProcessedMessageListRelationFilter";
...
class MessageWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ProcessedMessageListRelationFilter,
  })
  @ValidateNested()
  @Type(() => ProcessedMessageListRelationFilter)
  @IsOptional()
  @Field(() => ProcessedMessageListRelationFilter, {
    nullable: true,
  })
